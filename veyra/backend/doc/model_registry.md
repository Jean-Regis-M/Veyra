...
|----------|--------------|----------|--------|--------|
| `rule_set_3` | Rule Set 3 (Doench 2021) | 1 | `verified` | rs3 v0.0.15 with LightGBM compatibility shim for `_n_classes` attribute |
| `rule_set_2` | Rule Set 2 (Doench 2016/Azimuth 2.0) | 2 | `incompatible` | Requires Python 2.7 with scikit-learn 0.17.1 (Azimuth 2.0 official spec). Conda/micromamba provisioning available via `models setup rule_set_2` |
